export default function InstructionOverview() {
  return (
    <section id="overview" className="container section-spacing lg:text-lg">
      ...
      <p className="mt-8">
        Documentation is not always conducive to learning. It is oftentimes either too simple, or too advanced to answer
        the questions you may have. It also rarely delves into essential skills in modern frontend development like
        project scaffolding, organization, abstraction, and much more.
      </p>
      <p className="mt-8">
      ...
      <p className="mt-8">
        Pair-programming sessions open up a dialog for specific questions and practical experience working in the tools
        you want to get stronger with.
      </p>
    </section>
  )
}
