...
export default function PhoneCarousel(props) {
  ...
  return (
    <div className="flex items-center gap-4">
      <button aria-label="View previous image" onClick={previous} className={props.color}>
      ...
      <div className="relative aspect-[288/600] rounded-3xl lg:rounded-[45px] shadow-[0_0_2px_2px_rgba(255,255,255,0.1)] border-8 border-zinc-900 ml-1">
        ...
        <div className="aspect-[1206/2622] relative w-full h-full rounded-2xl lg:rounded-[37px] overflow-hidden bg-zinc-900/10 grid grid-cols-1 grid-rows-1">
          <div className="z-[-1] col-start-1 row-start-1 bg-white"></div>
      ...
      <button aria-label="View next image" onClick={next} className={props.color}>
