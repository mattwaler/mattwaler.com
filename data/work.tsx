export default [
  ...
  },
  {
    ...
    description: "A research-aggregate website focused on providing tools for people to promote youth development.",
  ...
  },
  {
    ...
    description: "A website highlighting Hamilton Exhibits innovative brand spaces and how they can make an impact.",
  ...
  },
  {
    ...
    description: "A nation-wide website to communicate and highlight the first Greek-letter fraternity for women.",
  ...
  {
    title: "IU Health",
    description: "A full-service web application for the Indiana branch of University Hospitals.",
  ...
  {
    title: "Sexy Hair",
    description: "An e-commerce website for the hairspray & more brand Sexy Hair.",
  ...
  },
  {
    ...
    description: "An e-commerce website for a Cleveland-based nature-first juice company.",
